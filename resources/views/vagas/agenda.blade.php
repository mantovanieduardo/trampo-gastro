            ...
            @forelse ($trabalhos as $trabalho)
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <!-- Botão de avaliar -->
                        <!-- Botão de chat com restaurante -->
                        <a href="{{ route('mensagens.show', [$trabalho->vaga_id, $trabalho->restaurante_user_id]) }}"
                           class="w-full mb-2 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 text-xs font-semibold rounded-lg transition-colors ring-1 ring-blue-200">
